...
public class XHTMLImporterImpl implements XHTMLImporter {
    ...
    public List<Object> convert(String content,  String baseUrl) throws Docx4JException {
        ...
        try {
        	dom = XMLResource.load(is).getDocument();
	        	...
	        	throw new Docx4JException("issues at Line ");	        		
        }
     ...
     * @return
     */
    public Map<String, CSSValue> getCascadedProperties(com.openhtmltopdf.css.style.CalculatedStyle cs) {
...
//    	log.debug("BEFORE " + XmlUtils.marshaltoString(pPr, true, true));
        ...
        for (Object o : cssMap.keySet()) {
    		...
    		Property p = null;
        	if(cssValue!=null) {
        		p = PropertyFactory.createPropertyFromCssName(cssName, cssValue);
        	}
...
//        }
	...
	private int getBBIndentContrib(BlockBox bb) {
		...
		if (bb.getStyle()!=null
			...
			if(padding.getCSSPrimitiveValue()!=null)
...
//		log.debug("+padding-left: " + totalPadding);
		...
		if (bb.getStyle()!=null
			...
			if(margin.getCSSPrimitiveValue()!=null)
...
//		log.debug("+margin-left: " + totalPadding);
    ...
    private void addRunProperties(RPr rPr, Map cssMap) {
        ...
        for (Object o : cssMap.keySet()) {
        	...
        	Property runProp = null;
        	if(cssValue!=null)
        		runProp = PropertyFactory.createPropertyFromCssName(cssName, cssValue);
